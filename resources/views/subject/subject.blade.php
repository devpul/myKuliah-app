...
@section('content')
    <div class="flex justify-between items-center">
        <div class="flex flex-col">
            ...
            <p>Kelola semua mata kuliah semester ini</p>
        </div>
        <a href="{{ route('create_subject') }}" class="bg-blue-500 font-semibold text-white text-center p-2 rounded shadow">Tambah Mata Kuliah</a>
    </div>
