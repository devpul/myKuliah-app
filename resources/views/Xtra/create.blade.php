...
@section('title', 'Add Xtra Activity - MyKuliah')
...
@section('content')
    <div class="px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
            <h1 class="text-2xl font-bold text-gray-900 mb-6">Add New Activity</h1>
            ...
            <form action="{{ route('xtra.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                        ...
                        placeholder="Add a short description or notes for the activity...">{{ old('description') }}</textarea>
                    @error('description')
                         <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
